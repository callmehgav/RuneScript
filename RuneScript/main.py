    ...
    def run(self):
        while self.program_running:
            while self.running:
                ...
                #noSleepButtonPress(self)
                #noSleepSpacePress(self)
                #randomAutoClickerWithINVDROP(self)
                #buttonPress(self)
                ...
                #spaceClicker(self) #caps and drops
                #fishingBot(self)
...
def barbBot(self):
    ...
    #move mouse to log
    moveMouse(returnInt(645, 664),returnInt(568, 580))
    time.sleep(.6)
    mouse.click(self.button)
    time.sleep(np.random.randint(9,10))

    #move mouse wall
    moveMouse(returnInt(598, 618),returnInt(633, 640))
    time.sleep(.6)
    mouse.click(self.button)
    time.sleep(np.random.randint(9,10))

    #move mouse wall
    moveMouse(returnInt(670, 674),returnInt(435, 442))
    time.sleep(.6)
    mouse.click(self.button)
    time.sleep(np.random.randint(6,7))

    #move mouse bow
    moveMouse(returnInt(617, 622),returnInt(483, 488))
    time.sleep(.6)
    mouse.click(self.button)
    time.sleep(np.random.randint(7,9))

    #move mouse beam
    moveMouse(returnInt(770, 782),returnInt(476, 477))
    time.sleep(.6)
    mouse.click(self.button)
    time.sleep(np.random.randint(4,5))

    #move mouse gap
    moveMouse(returnInt(738, 756),returnInt(471, 483))
    time.sleep(.6)
    mouse.click(self.button)
    time.sleep(np.random.randint(4,5))

    #move mouse slide
    moveMouse(returnInt(773, 788),returnInt(469, 477))
    time.sleep(.6)
    mouse.click(self.button)
    time.sleep(np.random.randint(6,7))

    #move mouse start
    moveMouse(returnInt(983, 997),returnInt(441, 450))
    time.sleep(.6)
    mouse.click(self.button)
    time.sleep(np.random.randint(6,7))

    #move mouse rope
    moveMouse(returnInt(717, 719),returnInt(525, 527))
    time.sleep(.6)
...
def fishingBot(self):
    ...
    moveMouse(returnInt(250, 280),returnInt(441, 461))
    print("Moved")
    time.sleep(returnInt(1, 2))
    #click
    mouse.click(self.button)
    ...
    moveMouse(returnInt(740, 765), returnInt(460, 490))
    print("Moved")
    ...
    #move mouse to bank
    moveMouse(returnInt(1100,1135),returnInt(407,445))
    print("Moved")
...
def noSleepButtonPress(self):
    keyboard.press('e')
    keyboard.release('e')
    time.sleep( np.random.randint(60,120))

def noSleepSpacePress(self):
    keyboard.press(Key.space)
    keyboard.release(Key.space)
    time.sleep( np.random.randint(15,20))

def randomAutoClickerWithINVDROP(self):
    ...
    mouse.click(self.button)
    time.sleep( np.random.randint(1,4))
    if(np.random.randint(1,101)==100):
        print("super press")
        for x in range(1,np.random.randint(2,6)):
            mouse.click(self.button)
            time.sleep(.1)
...
def ringsOfSlaying(self):
    ...
    moveMouse(returnInt(1370, 1393),returnInt(150, 162))
    time.sleep(np.random.randint(1,2))
    # Click
    mouse.click(self.button)
    ...
    keyboard.press(Key.space)
    keyboard.release(Key.space)
    time.sleep(np.random.randint(45,50))


    moveMouse(returnInt(70, 78),returnInt(719, 724))
    time.sleep(np.random.randint(1,2))
    # Click
    mouse.click(self.button)
